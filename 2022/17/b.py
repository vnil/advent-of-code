...
while True:
    if tallest == 396:
        print(':: 396', count, stone_index, steam_index)
    if tallest == 3177:
        print(':: 3177', count, stone_index, steam_index)
    if count == caa:
        break
    count += 1
...
# Manuall find reoccuring height
# tallest, count, stone_index, steam_index
#:: 396 253 3 1459
#:: 3177 2003 3 1459


#(1000000000000 - 253) / (2003 - 253) => 571428571
# 571428571 times reoccuring height of (3178 - 397)

#571428571*(2003-253) = 999999999250

#(3178 - 397) = 2781

# 253 gånger, 571428571*(3178 - 397), +497 gånger till
#=> 750 stones + 571428571*(3178 - 397)

#750 stones => height 1232
1232+571428571*(3178 - 397) # Part 2 answer my input